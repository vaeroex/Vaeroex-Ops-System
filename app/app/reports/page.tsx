  ...
  const managedReports = reports.map((report) => {
    ...
    return {
      ...
      meta: [
        ...
        { label: "Business Signals", value: numberFromSource(report.source_data_json, "completed_tasks") },
        ...
        { label: "Business context", value: numberFromSource(report.source_data_json, "overdue_tasks") },
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="vaeroex-mobile-safe-scroll flex gap-2 overflow-x-auto pb-1">
        {[
          { label: "Business Signals", value: openTaskCount.count ?? 0 },

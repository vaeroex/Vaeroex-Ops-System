    ...
    <div className="space-y-6">
      ...
      <section className="rounded-xl border border-amber-300/25 bg-amber-950/20 p-4 text-amber-50">
        ...
        <p className="mt-2 max-w-4xl text-sm leading-6 text-amber-100/85">
          Existing rows remain available as historical evidence so Business Memory, Search, and Intelligence can understand past customer activity. New customer information should enter Vaeroex through Sources, uploaded files, Business Memory, or future external system integrations.
        </p>

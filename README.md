...
The company is **Vaeroex** and the flagship product is **Executive Intelligence**. Customer-facing intelligence surfaces use Business Health, Intelligence, Explain Finding, Evidence, and Saved Analyses terminology.
...
The original Phase 4 Vaeroex Hub and generic Agents workflows are retired. Current model-backed behavior is bounded to Executive Intelligence and file analysis. `ai_agent_runs` remains workspace-scoped compatibility storage for Business Health explanations, Finding explanations, and file-analysis lineage; it is not a customer-facing run history.
...
- Current bounded provider infrastructure, canonical intelligence snapshots, active artifact storage, and Saved Analysis confirmation flow

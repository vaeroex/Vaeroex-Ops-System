...
export const helpArticles: HelpArticle[] = [
  ...
  article({
    ...
    what: "Operations Intelligence analyzes business evidence such as KPIs, files, reports, customer pipeline context, Business Signals, issues, and historical memory.",
  ...
  ...[
    ...
    ["crm", "Customer Pipeline Context", "Lead and customer activity used as evidence for risk, opportunity, and revenue trends.", "/app/crm"],
  ...
  ...[
    ...
    ["health-score-general", "How Business Health Score is calculated generally", "The score is directional and based on available KPI, customer pipeline, issue, report, people, file, and Business Signal evidence."],
    ["profit-leak-general", "How Profit Leak Detector works generally", "Vaeroex looks for revenue and opportunity signals such as stalled leads, missed targets, response delays, and weak source evidence."],
...
export const contextualHelp: Record<string, { what: string; workflow: string[]; mistakes: string[]; related: string[] }> = {
  ...
  crm: {
    what: "Customer pipeline context helps Vaeroex understand revenue, conversion, response speed, and opportunity signals.",
    workflow: ["Add pipeline context", "Review status", "Review conversion", "Compare against revenue"],
    mistakes: ["Stale lead status", "Missing source", "Treating pipeline samples as complete history"],

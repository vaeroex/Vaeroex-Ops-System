...
export const helpArticles: HelpArticle[] = [
  ...
  article({
    ...
    what: "Operations Intelligence analyzes business evidence such as KPIs, files, reports, customer activity evidence, issues, and historical memory.",
  ...
  article({
    ...
    when: "Use this mindset when reviewing KPIs, Evidence, files, reports, and briefings.",
  ...
  ...[
    ...
    article({
      ...
      nextHref: href as Route,
      related: ["Reports", "Search", "Ask Vaeroex"]
    })
  ),
  ...[
    ...
    ["health-score-general", "How Business Health Score is calculated generally", "The score is directional and based on available KPI, customer activity, issue, report, organization, and file evidence."],
...
export const contextualHelp: Record<string, { what: string; workflow: string[]; mistakes: string[]; related: string[] }> = {
  ...
  "ask vaeroex": {
    what: "Use Ask Vaeroex for focused executive questions. Use Search when you need to locate a workspace record.",

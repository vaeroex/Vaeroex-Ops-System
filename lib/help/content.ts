...
export const helpArticles: HelpArticle[] = [
  article({
    ...
    summary: "Vaeroex is an Operations Intelligence Platform for growing businesses.",
    what: "Vaeroex helps organize business signals from KPIs, CRM, files, reports, SOPs, checklists, issues, people, and follow-ups.",
    why: "Owners and managers need one place to see what is happening, who owns it, and what needs attention.",
  ...
  article({
    id: "operations-intelligence-platform",
    category: "Getting Started",
    title: "What is an Operations Intelligence Platform?",
    summary: "A way to turn daily business activity into visibility, accountability, and execution.",
    what: "Operations intelligence connects records, trends, roles, and recommendations so leadership can make better-informed decisions.",
    why: "Small businesses often outgrow spreadsheets, memory, and hallway updates before they build structure.",
    when: "Use it when growth creates recurring handoff problems, unclear ownership, or reporting gaps.",
    workflow: ["Track KPIs", "Record customer and operational issues", "Use reports to find patterns", "Assign owners", "Review outcomes"],
    mistakes: ["Tracking too many metrics at once", "Not assigning owners", "Ignoring stale records"],
    nextLabel: "Create first KPI",
    nextHref: "/app/kpis",
    related: ["KPIs", "Reports", "Business Health Score"]
  }),
  article({
  ...
  ...[
    ...
    ["human-review-required", "Why human review is required", "Outputs may be incomplete or unsuitable, so users must review before acting."],

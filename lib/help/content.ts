...
export const helpArticles: HelpArticle[] = [
  article({
    ...
    summary: "Vaeroex: Intelligence Systems.",
    what: "Vaeroex transforms complex information into visibility, awareness, prediction, and action across specialized intelligence domains.",
    why: "Complex environments often contain many signals but limited structure for understanding what is happening, why it matters, what may happen next, and what action should follow.",
    when: "Use this guide when you want the company-level explanation before exploring a specialized Vaeroex intelligence environment.",
    workflow: ["Understand the Vaeroex intelligence philosophy", "Review the current intelligence areas", "Open Trust Center before uploading data", "Use support or contact channels when needed"],
  ...
  article({
    ...
    what: "Information provides the inputs. Visibility shows what is happening. Awareness connects context and meaning. Prediction identifies supported directional change. Action helps people decide what deserves focus next.",
    why: "Information becomes more useful when people can see it, understand it, anticipate supported change, and act on it.",
    when: "Use these pillars when reviewing Vaeroex Intelligence Systems.",

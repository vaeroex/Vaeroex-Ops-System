export const EASTER_EGG_GAME_CONTRACT_VERSION = "easter_egg_runner_v3" as const;
export const EASTER_EGG_LEGACY_GAME_CONTRACT_VERSIONS = ["easter_egg_runner_v1", "easter_egg_runner_v2"] as const;

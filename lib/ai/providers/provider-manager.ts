...
function logAttempt(
  ...
  const payload = {
    ...
    relationshipCategory: diagnostic?.relationshipCategory || null,
    citedSignalIds: diagnostic?.citedSignalIds || [],
    numericSupportMode: diagnostic?.numericSupportMode || null,
    supportedNumericCount: diagnostic?.supportedNumericCount ?? null,
    emittedNumericCount: diagnostic?.emittedNumericCount ?? null,
    unsupportedNumericCount: diagnostic?.unsupportedNumericCount ?? null,

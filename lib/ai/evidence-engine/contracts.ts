...
export type RerankResult = Readonly<{
  ...
  latencyMs: number;
  failureCode: "disabled" | "missing_credentials" | "timeout" | "rate_limit" | "unavailable" | "malformed_response" | "transport_failure" | "circuit_breaker_open" | "unsafe_benchmark_input" | null;
}>;

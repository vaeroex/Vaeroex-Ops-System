...
export const SQUARE_ORDER_ADJUSTMENT_RESPONSE_CONTRACT_VERSION =
  "square_order_adjustment_response_v1" as const;
export const SQUARE_ORDER_ADJUSTMENT_MINIMIZATION_VERSION =
  "square_order_adjustment_minimizer_v1" as const;
export const SQUARE_ORDER_ADJUSTMENT_ENTITY_VERSION = 1 as const;
export const SQUARE_ORDER_TENDER_RESPONSE_CONTRACT_VERSION =
  "square_order_tender_response_v1" as const;
export const SQUARE_ORDER_TENDER_MINIMIZATION_VERSION =
  "square_order_tender_minimizer_v1" as const;
export const SQUARE_ORDER_TENDER_ENTITY_VERSION = 1 as const;
...
export const SQUARE_PHASE_2B1B2_SUPPORTED_CATALOG_OBJECT_TYPES = [
  "CATEGORY",
  "ITEM",
  "ITEM_VARIATION",
  "MODIFIER_LIST",
...
export const SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE = Object.freeze({
  ITEM: "item_data",
  IMAGE: "image_data",
...
export type SquareCatalogObjectTypeDataKey =
  (typeof SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE)[keyof typeof SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE];

export const SQUARE_CATALOG_OBJECT_TYPE_DATA_KEYS = Object.freeze([
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.ITEM,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.IMAGE,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.CATEGORY,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.ITEM_VARIATION,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.TAX,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.DISCOUNT,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.MODIFIER_LIST,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.MODIFIER,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.PRICING_RULE,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.PRODUCT_SET,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.TIME_PERIOD,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.MEASUREMENT_UNIT,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.SUBSCRIPTION_PLAN_VARIATION,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.ITEM_OPTION,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.ITEM_OPTION_VAL,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.CUSTOM_ATTRIBUTE_DEFINITION,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.QUICK_AMOUNTS_SETTINGS,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.SUBSCRIPTION_PLAN,
  SQUARE_CATALOG_OBJECT_TYPE_DATA_KEY_BY_TYPE.AVAILABILITY_PERIOD
] as const satisfies readonly SquareCatalogObjectTypeDataKey[]);
...
export const SQUARE_ALLOWED_CATALOG_MODIFIER_LIST_SELECTION_TYPES = [
  "SINGLE",
  "MULTIPLE"
] as const;

export const SQUARE_ALLOWED_CATALOG_MODIFIER_LIST_MODIFIER_TYPES = [
  "LIST",
  "TEXT"
] as const;

export const SQUARE_ALLOWED_CATALOG_DISCOUNT_TYPES = [
  "FIXED_PERCENTAGE",
  "FIXED_AMOUNT",
  "VARIABLE_PERCENTAGE",
  "VARIABLE_AMOUNT"
...
export const SQUARE_ALLOWED_CATALOG_DISCOUNT_TAX_BASIS_TYPES = [
  "MODIFY_TAX_BASIS",
  "DO_NOT_MODIFY_TAX_BASIS"
] as const;

export const SQUARE_ALLOWED_CATALOG_TAX_CALCULATION_PHASES = [
  "TAX_SUBTOTAL_PHASE",
  "TAX_TOTAL_PHASE"
] as const;

export const SQUARE_ALLOWED_CATALOG_TAX_INCLUSION_TYPES = [
  "ADDITIVE",
  "INCLUSIVE"
] as const;

...
export const BUSINESS_HEALTH_CALCULATION_VERSION = "business_health_calculation_v1" as const;
export const DATA_QUALITY_CALCULATION_VERSION = "data_quality_calculation_v1" as const;

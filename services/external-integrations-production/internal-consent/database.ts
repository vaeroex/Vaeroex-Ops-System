...
const operations = {
  oauth: new Set(["create_state", "consume_state", "deny_state", "reconcile_state"]),
  broker: new Set(["acquire_exchange", "reconcile_acquire", "commit_credential", "reconcile_exchange"])
};
const sql = {
 ...
 */
export function createInternalRpc(profile: "oauth" | "broker", open: () => Promise<Database>): InternalRpc {

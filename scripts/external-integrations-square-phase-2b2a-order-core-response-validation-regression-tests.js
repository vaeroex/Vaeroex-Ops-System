...
function testDormancyInvariantsAndSources() {
  ...
  doesNotMatch(responseSource, /payments:|refunds:|fulfillments:|webhook|queue|migration|persist/i, "trusted response implementation adds no out-of-scope transaction normalization or runtime scope");
}

...
matches(migration, /drop constraint integration_qbo_provider_task_result_evi_contract_version_check;/, "provider-result convergence uses PostgreSQL's autogenerated catalog constraint name");
matches(migration, /drop constraint integration_qbo_report_parser_result_evi_contract_version_check;/, "parser-result convergence uses PostgreSQL's autogenerated catalog constraint name");
matches(migration, /add constraint integration_qbo_provider_result_contract_check/, "replacement provider-result constraints use stable sub-63-byte identifiers");
matches(migration, /add constraint integration_qbo_parser_result_contract_check/, "replacement parser-result constraints use stable sub-63-byte identifiers");

...
matches(migration, /drop constraint integration_qbo_provider_task_result_evidence_contract_version_;/, "provider-result convergence uses the historical catalog-truncated constraint name");
matches(migration, /drop constraint integration_qbo_report_parser_result_evidence_contract_version_;/, "parser-result convergence uses the historical catalog-truncated constraint name");

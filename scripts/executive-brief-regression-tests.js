...
assert.equal(fs.existsSync(path.join(root, "app/app/executive-brief/actions.ts")), false, "the unreachable Executive Brief generation action must stay deleted");
...
assert.equal(fs.existsSync(path.join(root, "components/intelligence/ExecutiveBriefPanel.tsx")), false, "the unreachable Executive Brief panel must stay deleted");

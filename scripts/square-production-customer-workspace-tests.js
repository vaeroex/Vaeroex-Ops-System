...
assert.match(workflow, /node scripts\/run-square-production-customer-qualification\.js/);
...
assert.equal(withoutSquareQualificationPaths('supabase/production-migrations/20260925032300_square_production_customer_connection.sql'), '');

...
equal(approvedSquareQualificationPaths.length, 95, "dormant scope permits only exact reviewed migrations, UI, native service/templates, provider-neutral Production composition, restricted evidence host and branch-only deployment guard");
assertionCount++;

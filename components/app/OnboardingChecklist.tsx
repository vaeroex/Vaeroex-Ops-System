...
export function OnboardingChecklist({ workspaceId, items, demoWorkspaceForm }: OnboardingChecklistProps) {
  ...
  return (
    <section className="rounded-lg border border-blue-100 bg-white p-5 shadow-panel">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div className="min-w-52 rounded-lg border border-line bg-slate-50 p-4">
          <div className="flex items-center justify-between gap-3">
            ...
            <button type="button" onClick={() => setHidden(true)} className="text-xs font-semibold text-muted underline">
              Hide
            </button>
          </div>
